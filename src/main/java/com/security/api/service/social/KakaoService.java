package com.security.api.service.social;

import com.google.gson.Gson;
import com.security.api.advice.exception.CCommunicationException;
import com.security.api.model.social.KakaoProfile;
import com.security.api.model.social.RetKakaoAuth;
...
public class KakaoService {
    ...
    public RetKakaoAuth getKakaoTokenInfo(String code) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            System.out.println(gson.fromJson(response.getBody(), RetKakaoAuth.class));
