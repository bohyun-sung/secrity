package com.security.api.advice;


import com.security.api.advice.exception.*;
...
public class ExceptionAdvice {
    ...
    private String getMessage(String code, Object[] args) {
        System.out.println(messageSource.getMessage(code, args, LocaleContextHolder.getLocale()));
